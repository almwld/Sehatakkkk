...
class FamilyPlanningScreen extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> _methods = const [
    ...
    },
    {
      'name': 'الواقي الذكري',
      'effectiveness': '98%',
      'duration': 'استخدام واحد',
      'color': AppColors.warning,
      'desc': 'يحمي من الأمراض المنقولة',
    },
    {
      'name': 'الغرسة',
      'effectiveness': '99.9%',
            ...
            Container(
              ...
              child: const Row(
                children: [
                  ...
                  Expanded(
                    child: Text(
                      'استشيري طبيبك لاختيار الوسيلة الأنسب',
