    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          _menuItem(context, Icons.help_outline, 'المساعدة', 'أسئلة شائعة وتواصل', () => Navigator.push(context, MaterialPageRoute(builder: (_) => const HelpCenterScreen()))),
          _menuItem(context, Icons.share_rounded, 'مشاركة', 'شارك التطبيق', () => Navigator.push(context, MaterialPageRoute(builder: (_) => const ShareAppScreen()))),
