...
@override Widget build(BuildContext c)=>Scaffold(backgroundColor:const Color(0xFF0A0E1A),appBar:const FuturisticAppBar(title:'عداد الخطوات'),body:FuturisticBackground(glowColor:const Color(0xFF00E5A0),child:ListView(padding:const EdgeInsets.all(16),children:[
