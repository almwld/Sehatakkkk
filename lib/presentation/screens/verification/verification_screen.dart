          ...
          child: Padding(
            ...
            child: SizedBox(
              ...
              child: ElevatedButton.icon(
                onPressed:
                    (_submitting || _verified || _status == 'pending')
                        ? null
                        : _submitVerification,
                icon: Icon(
                  _status == 'pending'
                ...
                label: Text(
                  _status == 'pending'
                      ...
                      : _submitting
                          ? 'جاري إرسال طلب التوثيق...'
                          : 'إرسال طلب التوثيق والتحقق من المستندات',
                ),
        ...
        body: SingleChildScrollView(
          ...
          child: Column(
            children: [
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        _verified
                            ? 'تم اعتماد حسابك ويمكنك استخدام ميزات دورك.'
                            : _status == 'pending'
                                ? 'تم إرسال ملفك إلى المشرف وستصلك النتيجة عبر الإشعارات.'
                                : 'لاستخدام ميزات $_roleLabel يجب استكمال التوثيق وإرفاق المؤهلات والمستندات المطلوبة.',
                      ),
                    ],
                  ),
                ),
              ...
              _field(_age, 'العمر', type: TextInputType.number),
              _field(_specialty, 'التخصص'),
              _field(_license, 'رقم الترخيص/المزاولة'),
              _field(_experience, 'سنوات الخبرة'),
              _field(_academic, 'ملخص السجل الأكاديمي'),
              const SizedBox(height: 6),
              ..._specialRequirements.map(
                (x) => Align(
              ...
              _upload('academicRecord', 'السجل الأكاديمي'),
              _upload('certificates', 'الشهادات والمؤهلات'),
              _upload('professionalRecord', 'السجل المهني/الخبرات'),
              _upload('healthRecord', 'السجل الصحي/اللياقة المهنية'),
              _upload('identity', 'الهوية والمستندات الرسمية'),
              const SizedBox(height: 10),
              const Text(
                'الملفات المدعومة: PDF و JPG و PNG — الحد الأقصى 12MB للملف.',
