...
class _CartScreenState extends State<CartScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final delivery = _delivery ? _deliveryFee : 0;
    ...
    return Scaffold(
      ...
      body: _cart.items.isEmpty
          ? Center(child: Column(mainAxisSize: MainAxisSize.min, children: [Icon(Icons.shopping_cart, size: 80, color: Colors.grey[400]), const SizedBox(height: 16), Text('السلة فارغة', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: isDark ? Colors.white : Colors.black87)), const SizedBox(height: 8), Text('أضف منتجات من الصيدلية', style: TextStyle(color: isDark ? Colors.grey[400] : Colors.grey[600]))]))
          : ListView(padding: const EdgeInsets.all(16), children: [
              ...
              SwitchListTile(title: const Text('توصيل الطلب'), subtitle: Text(_delivery ? 'توصيل قياسي — $_deliveryFee ر.ي' : 'استلام بدون رسوم توصيل'), value: _delivery, onChanged: _processing ? null : (v) => setState(() => _delivery = v)),
