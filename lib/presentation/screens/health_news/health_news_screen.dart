...
class _HealthNewsScreenState extends State<HealthNewsScreen> {
  ...
  final List<Map<String, dynamic>> _news = [
    ...
    {
      'id': '2',
      'title': 'دراسة: المشي 30 دقيقة يومياً يقلل خطر الاكتئاب',
      'category': 'دراسات',
      'source': 'جامعة هارفارد',
      'date': '2026-07-01',
      'image': 'https://images.unsplash.com/photo-1449300079326-7b6bc2d1d28?w=400',
      'summary': 'دراسة جديدة تظهر أن المشي لمدة 30 دقيقة يومياً يمكن أن يقلل من خطر الاكتئاب بنسبة تصل إلى 25%.',
      'views': 987,
      'isSaved': false,
      'breaking': false,
    },
    ...
    {
      'id': '8',
      'title': 'دراسة: النظام الغذائي المتوسطي يعزز صحة الدماغ',
      'category': 'دراسات',
      'source': 'جامعة كامبريدج',
      'date': '2026-06-24',
      'image': 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?w=400',
      'summary': 'دراسة جديدة تؤكد أن النظام الغذائي المتوسطي يساهم في تعزيز صحة الدماغ وتأخير ظهور علامات الشيخوخة.',
      'views': 1123,
      'isSaved': false,
      'breaking': false,
    },
