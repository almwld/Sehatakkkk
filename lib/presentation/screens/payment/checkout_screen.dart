...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  final List<Map<String, dynamic>> _deliveryCompanies = [
    {'id': 'sehatak', 'name': 'توصيل صحتك', 'icon': ImageKit.deliverySehatak, 'available': true, 'badge': 'متاح'},
    {'id': 'nas', 'name': 'ناس', 'icon': ImageKit.deliveryNas, 'available': false, 'badge': 'قريباً'},
    {'id': 'tasheel', 'name': 'تساهيل', 'icon': ImageKit.deliveryTasheel, 'available': false, 'badge': 'قريباً'},
    {'id': 'other', 'name': 'توصيل', 'icon': ImageKit.deliveryOther, 'available': false, 'badge': 'قريباً'},
  ];
                      ...
                      child: Row(
                        children: [
                          Container(
                            ...
                            height: 50,
                            decoration: BoxDecoration(
                              color: isAvailable ? AppColors.primary.withOpacity(0.1) : Colors.grey.withOpacity(0.1),
                            ...
                            child: Center(
                              child: Image.network(
                                ...
                                errorBuilder: (context, error, stackTrace) {
                                  return Icon(Icons.delivery_dining, color: isAvailable ? AppColors.primary : Colors.grey, size: 32);
                                },
                              ),
                            ),
                          ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                  ...
                                  children: [
                                    Text(
                                      ...
                                      style: TextStyle(
                                        ...
                                        color: isAvailable ? (isDark ? Colors.white : Colors.black87) : Colors.grey,
                                      ),
                                    ),
                                    ...
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: isAvailable ? Colors.green.withOpacity(0.15) : Colors.orange.withOpacity(0.15),
                                        borderRadius: BorderRadius.circular(8),
                                      ),
                                      child: Text(
                                        company['badge'] as String,
                                        style: TextStyle(fontSize: 10, fontWeight: FontWeight.w600, color: isAvailable ? Colors.green : Colors.orange),
                                      ),
                                    ),
                                  ],
                                ),
                                ...
                                Text(
                                  isAvailable ? 'توصيل سريع وآمن' : 'سيتم تفعيل هذه الخدمة قريباً',
                          ...
                          if (isAvailable)
                            ...
                            Icon(Icons.lock_outline, color: isDark ? Colors.grey[600] : Colors.grey[400], size: 20),
                        ],
                      ),
                    );
                  }).toList(),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Text('متابعة إلى الدفع', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                          const SizedBox(width: 8),
