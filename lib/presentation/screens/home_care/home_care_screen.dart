...
class HomeCareScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: const Text('خدمات منزلية', style: TextStyle(fontWeight: FontWeight.bold))),
  ...
  Widget _card(String icon, String name, String desc, String price, String duration, Color color) {
    return Container(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        Container(padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 2), decoration: BoxDecoration(color: color.withOpacity(0.08), borderRadius: BorderRadius.circular(4)), child: Text('$price ر.ي • $duration', style: TextStyle(fontSize: 9, color: color))),
      ]),
    );
  }
}
