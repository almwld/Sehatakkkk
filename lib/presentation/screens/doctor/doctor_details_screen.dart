...
class _DoctorDetailsScreenState extends State<DoctorDetailsScreen> with SingleTickerProviderStateMixin {
    ...
    switch (widget.doctorId) {
      case '1':
        return {
          ...
          'about': 'استشاري باطنية وأطفال مع خبرة واسعة في تشخيص وعلاج الأمراض الباطنية.',
          'education': ['بكالوريوس طب - جامعة صنعاء', 'زمالة الباطنية - المجلس العربي'],
          'services': ['استشارة باطنية', 'استشارة أطفال', 'فحص شامل'],
          'availability': ['السبت - الأربعاء: 9 ص - 5 م', 'الخميس: 9 ص - 1 م']
        };
      case '2':
        return {
          'name': 'د. حسن رضا',
          ...
          'fee': '300',
          'available': true,
          'hospital': 'عيادة الصحة بلس',
          'about': 'طبيب عام متخصص في طب الأسرة.',
          'education': ['بكالوريوس طب - جامعة تعز'],
          'services': ['استشارة عامة', 'فحص دوري'],
          'availability': ['الأحد - الخميس: 8 ص - 4 م']
        };
      default:
        return {
          'name': 'د. أحمد محمد',
          ...
          'education': ['بكالوريوس طب - جامعة عدن'],
          'services': ['استشارة عامة'],
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CircleAvatar(
                        ...
                        child: Text(
                          doc['name'][0] + doc['name'][doc['name'].length - 3],
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: Text('${doc['fee']} ر.ي', style: const TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
                          ),
                          ...
                          Container(
                            ...
                            child: Text(doc['available'] ? 'متاح' : 'غير متاح', style: const TextStyle(color: Colors.white, fontSize: 12)),
                          ),
                        ],
                      ),
                    ],
              ...
              child: Row(
                ...
                children: [
                  _actionBtn(Icons.chat, 'محادثة', AppColors.info, () =>
                    ChatNavigation.openChat(context, doctorName: doc['name'], doctorId: widget.doctorId ?? '1')
                  ),
                  _actionBtn(Icons.videocam, 'فيديو', AppColors.success, () =>
                    ChatNavigation.openCall(context,
                      doctorName: doc['name'],
                  ...
                  _actionBtn(Icons.call, 'صوتي', AppColors.primary, () =>
                    ChatNavigation.openCall(context,
                      doctorName: doc['name'],
                      doctorId: widget.doctorId ?? '1',
                      chatId: 'call_${DateTime.now().millisecondsSinceEpoch}',
                  ...
                  _actionBtn(Icons.person_add, _isFollowing ? 'متابَع' : 'متابعة', AppColors.purple, () =>
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          ...(doc['availability'] as List).map((a) => Padding(
        ...
        children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      _starRow(4.9),
                      const SizedBox(height: 4),
                      const Text('3 تقييمات', style: TextStyle(fontSize: 13, color: AppColors.grey)),
                    ],
                  ),
                ),
              ],
          ...
          Row(
            ...
            children: List.generate(5, (i) =>
              IconButton(
                icon: Icon(i < _userRating ? Icons.star : Icons.star_border, color: AppColors.amber, size: 32),
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            spacing: 6,
            runSpacing: 6,
            children: ['9:00', '9:30', '10:00', '10:30', '11:00', '2:00', '2:30', '3:00', '4:00'].map((t) =>
              ChoiceChip(label: Text(t), selected: false, onSelected: (_) {})
            ).toList(),
          ),
          const SizedBox(height: 20),
          SizedBox(
  ...
  Widget _infoRow(IconData icon, String text, {Color color = AppColors.primary}) => Padding(
  ...
  Widget _starRow(double rating) {
    return Row(
      mainAxisSize: MainAxisSize.min,
      children: List.generate(5, (i) =>
        Icon(i < rating.floor() ? Icons.star : Icons.star_half, color: AppColors.amber, size: 18)
      ),
    );
  }
