...
class _ChatDetailScreenState extends State<ChatDetailScreen> {
  ...
  void _onScroll() {
    ...
    if (position.pixels >= position.maxScrollExtent * 0.8) _loadMoreMessages();
  }
  ...
  Future<void> _loadMoreMessages() async {
    ...
    _isLoadingMore = true;
    messagesBloc.add(LoadMoreMessages(chatId: widget.chatId, limit: 30));
            ...
            if (state is MessagesLoaded) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return MessageBubble(message: message, isMe: message.senderId == currentUserId);
                },
              );
            }
