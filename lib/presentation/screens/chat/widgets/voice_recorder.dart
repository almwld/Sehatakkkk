...
class _VoiceRecorderState extends State<VoiceRecorder> with SingleTickerProviderStateMixin {
  ...
  void _cancelRecording() {
    ...
    setState(() => _isRecording = false);
    _recorder.stop();
    widget.onCancel(); // ✅ العودة لشريط الكتابة
  }
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              // ✅ زر الإلغاء (X) - يعود لشريط الكتابة
              GestureDetector(
          ...
          Text(
            _isRecording ? 'اضغط ⏹ للإيقاف، ✖ للإلغاء' : 'اضغط مع الاستمرار للتسجيل',
            style: TextStyle(
              fontSize: 12,
