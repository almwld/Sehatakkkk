...
class _FormEditorState extends State<_FormEditor>{
 ...
 @override Widget build(BuildContext context){
  ...
  else if(widget.type=='labs')body=Expanded(child:ListView(children:[for(final group in _labGroups.entries)ExpansionTile(title:Text(group.key),children:[for(final t in group.value)CheckboxListTile(value:tests.contains(t),onChanged:(v){setState(()=>v==true?tests.add(t):tests.remove(t));},title:Text(t))]),f('notes','ملاحظات')]));
