...
class _IncomingCallScreenState extends State<IncomingCallScreen> with SingleTickerProviderStateMixin {
              ...
              child: DecoratedBox(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: isDark ? [const Color(0xFF08111F), const Color(0xFF14263A)] : [const Color(0xFF101B2D), const Color(0xFF19324A)],
                  ),
                ),
              ),
            ),
              ...
              children: [
                ...
                AnimatedBuilder(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(color: AppColors.primary.withOpacity(.8), width: 3),
                      boxShadow: [BoxShadow(color: AppColors.primary.withOpacity(.28), blurRadius: 32, spreadRadius: 8)],
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      Icon(widget.isVideo ? Icons.videocam_rounded : Icons.phone_rounded, color: Colors.white70, size: 17),
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      _buildCallButton(icon: _isMuted ? Icons.notifications_off_rounded : Icons.notifications_active_rounded, label: _isMuted ? 'تشغيل الرنين' : 'كتم الرنين', color: Colors.white, onTap: _isProcessing ? null : _toggleMute),
  ...
  Widget _buildCallButton({required IconData icon, required String label, required Color color, required VoidCallback? onTap, double size = 54, bool isMain = false}) {
    return Column(
      mainAxisSize: MainAxisSize.min,
      children: [
        GestureDetector(
          ...
          child: Opacity(
            ...
            child: Container(
              ...
              height: size,
              decoration: BoxDecoration(
                color: isMain ? color : color.withOpacity(.12),
                shape: BoxShape.circle,
                border: isMain ? null : Border.all(color: color.withOpacity(.45)),
                boxShadow: isMain ? [BoxShadow(color: color.withOpacity(.35), blurRadius: 18, spreadRadius: 3)] : null,
              ),
              child: Icon(icon, color: isMain ? Colors.white : color, size: size * .43),
            ),
          ),
        ),
