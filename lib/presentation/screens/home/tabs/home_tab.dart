...
class _HomeTabState extends State<HomeTab> with AutomaticKeepAliveClientMixin {
  ...
  // ============================================================
  // 🚀 الخدمات السريعة - خلفية خضراء شفافة موحدة
  // ============================================================
  final List<Map<String, dynamic>> _quickServices = [
    {'icon': 'assets/images/services/pharmacy.png', 'label': 'صيدلية', 'color': Colors.green, 'screen': const MedicinesScreen()},
    {'icon': 'assets/images/services/emergency.png', 'label': 'طوارئ', 'color': Colors.green, 'screen': const EmergencyNumbers()},
    {'icon': 'assets/images/services/medical_community.png', 'label': 'خدمات منزلية', 'color': Colors.green, 'screen': const ServicesScreen()},
    {'icon': 'assets/images/services/blood_donation.png', 'label': 'تبرع بالدم', 'color': Colors.green, 'screen': const BloodDonationScreen()},
    {'icon': 'assets/images/services/consultation.png', 'label': 'أطباء', 'color': Colors.green, 'screen': const DoctorsListScreen()},
    {'icon': 'assets/images/services/laboratory.png', 'label': 'مختبرات', 'color': Colors.green, 'screen': const LabsListScreen()},
    {'icon': 'assets/images/services/health_tips.png', 'label': 'صحة', 'color': Colors.green, 'screen': const HealthDashboard()},
    {'icon': 'assets/images/services/wallet.png', 'label': 'محفظة', 'color': Colors.green, 'screen': const WalletScreen()},
    {'icon': 'assets/images/services/consultation.png', 'label': 'استشارة', 'color': Colors.green, 'screen': const ConsultationScreen()},
    {'icon': 'assets/images/services/map_location.png', 'label': 'بالقرب منك', 'color': Colors.green, 'screen': const InteractiveMapScreen()},
  ];
  ...
  final List<Map<String, dynamic>> _dailyTips = [
    {'title': 'شرب الماء', 'subtitle': '8 أكواب يومياً', 'icon': Icons.water_drop, 'color': Colors.green, 'content': 'شرب 8 أكواب من الماء يومياً يحسن صحة البشرة ويساعد في التخلص من السموم ويحسن وظائف الكلى.'},
    {'title': 'المشي', 'subtitle': '30 دقيقة يومياً', 'icon': Icons.directions_walk, 'color': Colors.green, 'content': 'المشي 30 دقيقة يومياً يقلل خطر أمراض القلب والسكري ويعزز الصحة النفسية ويحسن جودة النوم.'},
    {'title': 'النوم', 'subtitle': '7-8 ساعات ليلاً', 'icon': Icons.nights_stay, 'color': Colors.green, 'content': 'النوم 7-8 ساعات يومياً يحسن الصحة النفسية والجسدية ويساعد في تقوية الذاكرة والمناعة.'},
    {'title': 'الفواكه', 'subtitle': '5 حصص يومياً', 'icon': Icons.apple, 'color': Colors.green, 'content': 'تناول 5 حصص من الفواكه والخضار يومياً يوفر الفيتامينات والمعادن الضرورية للجسم ويعزز المناعة.'},
  ];
  ...
  final List<Map<String, dynamic>> _featuredHospitals = [
    {'id': '1', 'name': 'مستشفى 22 مايو', 'location': 'صنعاء', 'image': ImageKit.hospital1, 'rating': 4.9, 'specialty': 'عام', 'open': true},
    {'id': '2', 'name': 'مستشفى آزال', 'location': 'صنعاء', 'image': ImageKit.hospital2, 'rating': 4.8, 'specialty': 'خاص', 'open': true},
    {'id': '3', 'name': 'مستشفى السبعين', 'location': 'صنعاء', 'image': ImageKit.hospital3, 'rating': 4.7, 'specialty': 'أطفال وولادة', 'open': true},
    {'id': '4', 'name': 'مستشفى الكويت', 'location': 'صنعاء', 'image': ImageKit.hospital4, 'rating': 4.8, 'specialty': 'جراحة', 'open': true},
    {'id': '5', 'name': 'المستشفى الجمهوري', 'location': 'صنعاء', 'image': ImageKit.hospital5, 'rating': 4.6, 'specialty': 'حكومي', 'open': true},
    {'id': '6', 'name': 'مستشفى الثورة العام', 'location': 'صنعاء', 'image': ImageKit.hospital6, 'rating': 4.5, 'specialty': 'حكومي', 'open': true},
  ];
        ...
        CarouselSlider(
          ...
          items: _bannerImages.map((url) {
            return Container(
              ...
              child: ClipRRect(
                borderRadius: BorderRadius.circular(16),
                child: AppImage(url: url, height: 160, width: double.infinity, fit: BoxFit.cover),
              ),
            );
          }).toList(),
        ),
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Image.asset(
                        ...
                        color: Colors.green,
                        errorBuilder: (context, error, stackTrace) {
                          return Icon(Icons.circle, color: Colors.green, size: 28);
                        },
                      ),
                    ),
                  ),
  ...
  // ============================================================
  // 💡 النصائح اليومية - خلفية خضراء شفافة موحدة
  // ============================================================
                    ...
                    child: Row(
                      children: [
                        Icon(
                          ...
                          color: post['liked'] == true ? Colors.green : (isDark ? Colors.grey[400] : Colors.grey[600]),
                          size: 18,
                        ),
                  ...
                  child: Row(
                    children: [
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          padding: const EdgeInsets.all(8),
                          child: _buildServiceIcon('assets/images/services/notifications.png', Colors.green, size: 24),
                        ),
                      ),
                      GestureDetector(
                        ...
                        child: Container(
                          padding: const EdgeInsets.all(8),
                          child: _buildServiceIcon('assets/images/services/wallet.png', Colors.green, size: 24),
                        ),
                      ),
                    ],
                  ),
