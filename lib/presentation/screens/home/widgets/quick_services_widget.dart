...
class QuickServicesWidget extends StatelessWidget {
  ...
  static const List<Map<String,dynamic>> _services=[
    ...
    {'icon':'assets/images/services/medical_community.png','label':'خدمات منزلية','screen':ServicesScreen.new},
    {'icon':'assets/images/services/blood_donation.png','label':'تبرع بالدم','screen':BloodDonationScreen.new},
    {'icon':'assets/icons/services/doctors.png','label':'أطباء','screen':DoctorsListScreen.new},
    {'icon':'assets/images/services/laboratory.png','label':'مختبرات','screen':LabsListScreen.new},
    {'icon':'assets/images/services/health_tips.png','label':'صحة','screen':HealthDashboard.new},
    {'icon':'assets/images/services/wallet.png','label':'محفظة','screen':WalletScreen.new},
    {'icon':'assets/images/services/consultation.png','label':'استشارة','screen':ConsultationScreen.new},
