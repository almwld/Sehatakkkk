...
class _HomeScreenState extends State<HomeScreen> with WidgetsBindingObserver {
 ...
 void _check(){final v=FirebaseAuth.instance.currentUser!=null;if(mounted&&v!=_isLoggedIn)setState(()=>_isLoggedIn=v);}
 ...
 @override void didChangeAppLifecycleState(AppLifecycleState s){if(s==AppLifecycleState.resumed){_check();_systemNav();}}
