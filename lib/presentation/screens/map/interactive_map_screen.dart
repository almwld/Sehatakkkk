...
class _InteractiveMapScreenState extends State<InteractiveMapScreen> {
  ...
  final List<Map<String, dynamic>> _hospitals = [
    ...
    {'name': 'مستشفى جامعة العلوم والتكنولوجيا', 'address': 'شارع الستين، شارع الستين الشمالي', 'lat': 15.3400, 'lng': 44.1700, 'phone': '01-666666', 'type': 'جامعي', 'beds': '250', 'emergency': true, 'image': '🏥', 'rating': 4.5},
    ...
    {'name': 'مستشفى الأزهر', 'address': 'شارع الستين، حي الأزهر', 'lat': 15.3355, 'lng': 44.1865, 'phone': '01-333999', 'type': 'خاص', 'beds': '95', 'emergency': true, 'image': '🏥', 'rating': 3.8},
  ...
  final List<Map<String, dynamic>> _labs = [
    {'name': 'المختبر الوطني', 'address': 'شارع الستين، أمام المستشفى العسكري', 'lat': 15.3540, 'lng': 44.2030, 'phone': '01-012345', 'tests': '650+', 'image': '🔬', 'accredited': true, 'homeService': true, 'rating': 4.7},
    {'name': 'مختبر الثقة', 'address': 'شارع الزبيري، عمارة النعمان', 'lat': 15.3520, 'lng': 44.1980, 'phone': '01-123456', 'tests': '520+', 'image': '🔬', 'accredited': true, 'homeService': true, 'rating': 4.5},
    {'name': 'مختبر البرج', 'address': 'شارع هائل، جولة كنتاكي', 'lat': 15.3620, 'lng': 44.1960, 'phone': '01-234567', 'tests': '480+', 'image': '🔬', 'accredited': true, 'homeService': false, 'rating': 4.2},
    {'name': 'مختبر اليقين', 'address': 'شارع التحرير، عمارة البساطي', 'lat': 15.3570, 'lng': 44.1940, 'phone': '01-345678', 'tests': '350+', 'image': '🔬', 'accredited': true, 'homeService': true, 'rating': 4.0},
    {'name': 'مختبرات الحياة', 'address': 'شارع الخمسين، الحصبة', 'lat': 15.3780, 'lng': 44.2070, 'phone': '01-456789', 'tests': '420+', 'image': '🔬', 'accredited': false, 'homeService': true, 'rating': 3.8},
    {'name': 'معمل ابن سينا', 'address': 'شارع الزبيري، بجانب برج زبيدة', 'lat': 15.3490, 'lng': 44.1960, 'phone': '01-567890', 'tests': '380+', 'image': '🧪', 'accredited': true, 'homeService': false, 'rating': 4.3},
    {'name': 'مختبر الأمل', 'address': 'شارع هائل، أمام جامعة صنعاء', 'lat': 15.3650, 'lng': 44.1970, 'phone': '01-678901', 'tests': '290+', 'image': '🔬', 'accredited': false, 'homeService': true, 'rating': 3.6},
    {'name': 'معامل النخبة', 'address': 'شارع الستين، مجمع النخبة', 'lat': 15.3330, 'lng': 44.1820, 'phone': '01-789012', 'tests': '550+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.6},
    {'name': 'مختبر الشروق', 'address': 'شارع القاهرة، باب اليمن', 'lat': 15.3480, 'lng': 44.2020, 'phone': '01-890123', 'tests': '310+', 'image': '🔬', 'accredited': false, 'homeService': false, 'rating': 3.5},
    {'name': 'معمل الدقة', 'address': 'شارع العدين، السنينة', 'lat': 15.3860, 'lng': 44.2110, 'phone': '01-901234', 'tests': '460+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.4},
    {'name': 'مختبر الصحة', 'address': 'شارع الأربعين، شارع صخر', 'lat': 15.3140, 'lng': 44.1780, 'phone': '01-112345', 'tests': '270+', 'image': '🔬', 'accredited': false, 'homeService': true, 'rating': 3.4},
    {'name': 'معامل اليمن', 'address': 'شارع التحرير، عمارة الحمدي', 'lat': 15.3540, 'lng': 44.1920, 'phone': '01-223456', 'tests': '500+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.5},
    {'name': 'مختبر القدس', 'address': 'شارع الخمسين، دار الرئاسة', 'lat': 15.3710, 'lng': 44.2040, 'phone': '01-334567', 'tests': '340+', 'image': '🔬', 'accredited': true, 'homeService': false, 'rating': 4.1},
    {'name': 'معمل الرازي', 'address': 'شارع باب اليمن، سوق الملح', 'lat': 15.3430, 'lng': 44.2000, 'phone': '01-445678', 'tests': '410+', 'image': '🧪', 'accredited': false, 'homeService': true, 'rating': 3.9},
    {'name': 'مختبر الإيمان', 'address': 'شارع القاهرة، حي السياسي', 'lat': 15.3550, 'lng': 44.2060, 'phone': '01-556789', 'tests': '280+', 'image': '🔬', 'accredited': true, 'homeService': true, 'rating': 4.0},
    {'name': 'معامل الصفوة', 'address': 'شارع الستين، شارع تعز', 'lat': 15.3190, 'lng': 44.1790, 'phone': '01-667890', 'tests': '530+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.6},
    {'name': 'مختبر الجزيرة', 'address': 'شارع الزبيري، شارع السائلة', 'lat': 15.3470, 'lng': 44.1950, 'phone': '01-778901', 'tests': '360+', 'image': '🔬', 'accredited': false, 'homeService': false, 'rating': 3.7},
    {'name': 'معمل السلام', 'address': 'شارع هائل، حي الروضة', 'lat': 15.3670, 'lng': 44.1920, 'phone': '01-889012', 'tests': '440+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.3},
    {'name': 'مختبر الهدى', 'address': 'شارع الستين، جولة المصباحي', 'lat': 15.3270, 'lng': 44.1810, 'phone': '01-990123', 'tests': '250+', 'image': '🔬', 'accredited': false, 'homeService': true, 'rating': 3.3},
    {'name': 'معامل الفارابي', 'address': 'شارع التحرير، وسط البلد', 'lat': 15.3560, 'lng': 44.1950, 'phone': '01-001234', 'tests': '580+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.7},
    {'name': 'مختبر الأندلس', 'address': 'شارع العدين، طريق عمران', 'lat': 15.3880, 'lng': 44.2140, 'phone': '01-112456', 'tests': '320+', 'image': '🔬', 'accredited': true, 'homeService': false, 'rating': 3.8},
    {'name': 'معمل الحكمة', 'address': 'شارع الخمسين، بجانب الخطوط', 'lat': 15.3730, 'lng': 44.2060, 'phone': '01-223567', 'tests': '470+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.4},
    {'name': 'مختبر النور', 'address': 'شارع باب اليمن، شارع صالح', 'lat': 15.3440, 'lng': 44.1990, 'phone': '01-334678', 'tests': '390+', 'image': '🔬', 'accredited': false, 'homeService': true, 'rating': 3.6},
    {'name': 'معامل الأطباء', 'address': 'شارع القاهرة، بجانب السفارة', 'lat': 15.3520, 'lng': 44.2050, 'phone': '01-445789', 'tests': '510+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.5},
    {'name': 'مختبر اليمامة', 'address': 'شارع الستين، شارع مأرب', 'lat': 15.3290, 'lng': 44.1780, 'phone': '01-556890', 'tests': '260+', 'image': '🔬', 'accredited': false, 'homeService': false, 'rating': 3.2},
    {'name': 'معمل التعاون', 'address': 'شارع الزبيري، عمارة النجم', 'lat': 15.3500, 'lng': 44.1940, 'phone': '01-667901', 'tests': '430+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.2},
    {'name': 'مختبر المستقبل', 'address': 'شارع هائل، شارع الأربعين', 'lat': 15.3630, 'lng': 44.1980, 'phone': '01-778012', 'tests': '370+', 'image': '🔬', 'accredited': true, 'homeService': true, 'rating': 4.1},
    {'name': 'معامل الزهراء', 'address': 'شارع التحرير، أمام البنك', 'lat': 15.3590, 'lng': 44.1960, 'phone': '01-889123', 'tests': '490+', 'image': '🧪', 'accredited': true, 'homeService': false, 'rating': 4.3},
    {'name': 'مختبر الوفاء', 'address': 'شارع الستين، مجمع الصمد', 'lat': 15.3310, 'lng': 44.1840, 'phone': '01-990234', 'tests': '300+', 'image': '🔬', 'accredited': false, 'homeService': true, 'rating': 3.5},
    {'name': 'معمل الفيحاء', 'address': 'شارع الخمسين، مدينة النور', 'lat': 15.3760, 'lng': 44.2050, 'phone': '01-001345', 'tests': '540+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.6},
    {'name': 'مختبر الهلال', 'address': 'شارع باب اليمن، بجانب الجامع', 'lat': 15.3450, 'lng': 44.1970, 'phone': '01-112567', 'tests': '330+', 'image': '🔬', 'accredited': true, 'homeService': false, 'rating': 3.9},
    {'name': 'معامل الإخلاص', 'address': 'شارع القاهرة، حي الحشيشي', 'lat': 15.3560, 'lng': 44.2070, 'phone': '01-223678', 'tests': '450+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.4},
    {'name': 'مختبر طيبة', 'address': 'شارع العدين، طريق صنعاء', 'lat': 15.3840, 'lng': 44.2120, 'phone': '01-334789', 'tests': '280+', 'image': '🔬', 'accredited': false, 'homeService': true, 'rating': 3.5},
    {'name': 'معمل النهضة', 'address': 'شارع الزبيري، باب شعوب', 'lat': 15.3540, 'lng': 44.1970, 'phone': '01-445890', 'tests': '560+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.7},
    {'name': 'مختبر الربيع', 'address': 'شارع هائل، نهاية الخط', 'lat': 15.3660, 'lng': 44.1930, 'phone': '01-556901', 'tests': '240+', 'image': '🔬', 'accredited': false, 'homeService': false, 'rating': 3.2},
    {'name': 'معامل البراء', 'address': 'شارع الستين، تقاطع تعز', 'lat': 15.3170, 'lng': 44.1760, 'phone': '01-667012', 'tests': '480+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.3},
    {'name': 'مختبر العروبة', 'address': 'شارع التحرير، عمارة الكبوس', 'lat': 15.3600, 'lng': 44.1910, 'phone': '01-778123', 'tests': '310+', 'image': '🔬', 'accredited': true, 'homeService': true, 'rating': 4.0},
    {'name': 'معامل اليمن السعيد', 'address': 'شارع الستين، شارع العدين', 'lat': 15.3350, 'lng': 44.1860, 'phone': '01-889234', 'tests': '420+', 'image': '🧪', 'accredited': true, 'homeService': false, 'rating': 4.1},
    {'name': 'مختبر الإحسان', 'address': 'شارع الخمسين، حي المطار', 'lat': 15.3750, 'lng': 44.2090, 'phone': '01-990345', 'tests': '350+', 'image': '🔬', 'accredited': false, 'homeService': true, 'rating': 3.7},
    {'name': 'معمل الروضة', 'address': 'شارع باب اليمن، سوق الحلقة', 'lat': 15.3410, 'lng': 44.1980, 'phone': '01-001456', 'tests': '500+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.5},
    {'name': 'مختبر التوفيق', 'address': 'شارع القاهرة، بجانب المجلس', 'lat': 15.3570, 'lng': 44.2080, 'phone': '01-112678', 'tests': '270+', 'image': '🔬', 'accredited': false, 'homeService': true, 'rating': 3.4},
    {'name': 'معامل الخير', 'address': 'شارع الستين، طريق الحديدة', 'lat': 15.3150, 'lng': 44.1740, 'phone': '01-223789', 'tests': '460+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.4},
    {'name': 'مختبر الأنوار', 'address': 'شارع الزبيري، عمارة النجار', 'lat': 15.3460, 'lng': 44.1980, 'phone': '01-334890', 'tests': '380+', 'image': '🔬', 'accredited': true, 'homeService': false, 'rating': 4.0},
    {'name': 'معامل الهداية', 'address': 'شارع هائل، أمام المطار', 'lat': 15.3720, 'lng': 44.1890, 'phone': '01-445901', 'tests': '520+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.6},
    {'name': 'مختبر المنار', 'address': 'شارع العدين، السنينة الشمالية', 'lat': 15.3910, 'lng': 44.2150, 'phone': '01-556012', 'tests': '290+', 'image': '🔬', 'accredited': false, 'homeService': true, 'rating': 3.5},
    {'name': 'معامل التقوى', 'address': 'شارع الخمسين، خلف الجامعة', 'lat': 15.3790, 'lng': 44.2040, 'phone': '01-667123', 'tests': '440+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.3},
    {'name': 'مختبر البستان', 'address': 'شارع الستين، جولة 48', 'lat': 15.3360, 'lng': 44.1870, 'phone': '01-778234', 'tests': '360+', 'image': '🔬', 'accredited': true, 'homeService': false, 'rating': 3.8},
    {'name': 'معامل النجاح', 'address': 'شارع باب اليمن، ميدان التحرير', 'lat': 15.3480, 'lng': 44.2010, 'phone': '01-889345', 'tests': '500+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.5},
    {'name': 'مختبر اليسر', 'address': 'شارع القاهرة، حي السياسي', 'lat': 15.3540, 'lng': 44.2040, 'phone': '01-990456', 'tests': '330+', 'image': '🔬', 'accredited': false, 'homeService': true, 'rating': 3.6},
    {'name': 'معامل السعادة', 'address': 'شارع التحرير، بجانب البريد', 'lat': 15.3610, 'lng': 44.1920, 'phone': '01-001567', 'tests': '470+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.4},
    {'name': 'مختبر الريان', 'address': 'شارع الستين، شارع الستين الشمالي', 'lat': 15.3390, 'lng': 44.1710, 'phone': '01-112789', 'tests': '250+', 'image': '🔬', 'accredited': false, 'homeService': false, 'rating': 3.2},
    {'name': 'معامل دار الشفاء', 'address': 'شارع الزبيري، أمام الخطوط الجوية', 'lat': 15.3470, 'lng': 44.2000, 'phone': '01-223890', 'tests': '550+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.7},
    {'name': 'مختبر الأمن', 'address': 'شارع هائل، جولة كنتاكي', 'lat': 15.3640, 'lng': 44.1960, 'phone': '01-334901', 'tests': '390+', 'image': '🔬', 'accredited': true, 'homeService': true, 'rating': 4.1},
    {'name': 'معامل الصادق', 'address': 'شارع الخمسين، شارع الستين', 'lat': 15.3380, 'lng': 44.1880, 'phone': '01-445012', 'tests': '410+', 'image': '🧪', 'accredited': true, 'homeService': false, 'rating': 3.9},
    {'name': 'مختبر الفاروق', 'address': 'شارع باب اليمن، شارع باب اليمن', 'lat': 15.3500, 'lng': 44.1990, 'phone': '01-556123', 'tests': '300+', 'image': '🔬', 'accredited': false, 'homeService': true, 'rating': 3.4},
    {'name': 'معامل العنقاء', 'address': 'شارع الستين، جولة آية', 'lat': 15.3400, 'lng': 44.1730, 'phone': '01-667234', 'tests': '480+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.5},
    {'name': 'مختبر القاسمي', 'address': 'شارع التحرير، عمارة البساطي', 'lat': 15.3580, 'lng': 44.1930, 'phone': '01-778345', 'tests': '340+', 'image': '🔬', 'accredited': true, 'homeService': true, 'rating': 4.0},
    {'name': 'معامل الفتح', 'address': 'شارع الزبيري، شارع الستين', 'lat': 15.3320, 'lng': 44.1800, 'phone': '01-889456', 'tests': '420+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.2},
    {'name': 'مختبر النصر', 'address': 'شارع هائل، فرع الجامعة', 'lat': 15.3690, 'lng': 44.1950, 'phone': '01-990567', 'tests': '370+', 'image': '🔬', 'accredited': false, 'homeService': false, 'rating': 3.6},
    
    // مختبرات إضافية (تكملة للـ 100+)
    {'name': 'مختبر الأزهر', 'address': 'شارع الستين، حي الأزهر', 'lat': 15.3355, 'lng': 44.1865, 'phone': '01-112678', 'tests': '320+', 'image': '🔬', 'accredited': true, 'homeService': true, 'rating': 4.1},
    {'name': 'معمل التقوى الجديد', 'address': 'شارع هائل، جولة التقوى', 'lat': 15.3655, 'lng': 44.1955, 'phone': '01-223789', 'tests': '380+', 'image': '🧪', 'accredited': false, 'homeService': true, 'rating': 3.6},
    {'name': 'مختبر الهداية الجديد', 'address': 'شارع الخمسين، حي الهداية', 'lat': 15.3795, 'lng': 44.2095, 'phone': '01-334890', 'tests': '450+', 'image': '🔬', 'accredited': true, 'homeService': false, 'rating': 4.3},
    {'name': 'معمل الشفاء الجديد', 'address': 'شارع التحرير، حي الشفاء', 'lat': 15.3575, 'lng': 44.1925, 'phone': '01-445901', 'tests': '290+', 'image': '🧪', 'accredited': false, 'homeService': true, 'rating': 3.5},
    {'name': 'مختبر الأمان', 'address': 'شارع باب اليمن، حي الأمان', 'lat': 15.3465, 'lng': 44.1985, 'phone': '01-556012', 'tests': '410+', 'image': '🔬', 'accredited': true, 'homeService': true, 'rating': 4.0},
    {'name': 'معمل البناء', 'address': 'شارع القاهرة، حي البناء', 'lat': 15.3545, 'lng': 44.2055, 'phone': '01-667123', 'tests': '360+', 'image': '🧪', 'accredited': true, 'homeService': false, 'rating': 4.2},
    {'name': 'مختبر النجاح الجديد', 'address': 'شارع الستين، حي النجاح', 'lat': 15.3315, 'lng': 44.1775, 'phone': '01-778234', 'tests': '280+', 'image': '🔬', 'accredited': false, 'homeService': true, 'rating': 3.4},
    {'name': 'معمل التقدم', 'address': 'شارع العدين، حي التقدم', 'lat': 15.3875, 'lng': 44.2155, 'phone': '01-889345', 'tests': '430+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.4},
    {'name': 'مختبر الأمل الكبير', 'address': 'شارع الزبيري، حي الأمل الكبير', 'lat': 15.3495, 'lng': 44.2015, 'phone': '01-990456', 'tests': '310+', 'image': '🔬', 'accredited': true, 'homeService': false, 'rating': 3.8},
    {'name': 'معمل الحياة الكبير', 'address': 'شارع هائل، حي الحياة الكبير', 'lat': 15.3625, 'lng': 44.1975, 'phone': '01-001567', 'tests': '500+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.6},
    {'name': 'مختبر السلام الكبير', 'address': 'شارع الخمسين، حي السلام الكبير', 'lat': 15.3715, 'lng': 44.2075, 'phone': '01-112678', 'tests': '340+', 'image': '🔬', 'accredited': false, 'homeService': true, 'rating': 3.5},
    {'name': 'معمل النصر الجديد', 'address': 'شارع التحرير، حي النصر', 'lat': 15.3555, 'lng': 44.1935, 'phone': '01-223789', 'tests': '470+', 'image': '🧪', 'accredited': true, 'homeService': false, 'rating': 4.3},
    {'name': 'مختبر الفتح الجديد', 'address': 'شارع باب اليمن، حي الفتح', 'lat': 15.3485, 'lng': 44.2025, 'phone': '01-334890', 'tests': '260+', 'image': '🔬', 'accredited': false, 'homeService': true, 'rating': 3.2},
    {'name': 'معمل الأصالة', 'address': 'شارع القاهرة، حي الأصالة', 'lat': 15.3515, 'lng': 44.2045, 'phone': '01-445901', 'tests': '390+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 4.0},
    {'name': 'مختبر الريان الجديد', 'address': 'شارع الستين، حي الريان', 'lat': 15.3395, 'lng': 44.1735, 'phone': '01-556012', 'tests': '450+', 'image': '🔬', 'accredited': true, 'homeService': false, 'rating': 4.2},
    {'name': 'معمل المنار الجديد', 'address': 'شارع العدين، حي المنار', 'lat': 15.3835, 'lng': 44.2115, 'phone': '01-667123', 'tests': '330+', 'image': '🧪', 'accredited': false, 'homeService': true, 'rating': 3.6},
    {'name': 'مختبر الوفاء الكبير', 'address': 'شارع الزبيري، حي الوفاء', 'lat': 15.3475, 'lng': 44.1975, 'phone': '01-778234', 'tests': '520+', 'image': '🔬', 'accredited': true, 'homeService': true, 'rating': 4.5},
    {'name': 'معمل العطاء', 'address': 'شارع هائل، حي العطاء', 'lat': 15.3675, 'lng': 44.1945, 'phone': '01-889345', 'tests': '380+', 'image': '🧪', 'accredited': true, 'homeService': false, 'rating': 4.1},
    {'name': 'مختبر الشروق الجديد', 'address': 'شارع الخمسين، حي الشروق', 'lat': 15.3755, 'lng': 44.2045, 'phone': '01-990456', 'tests': '420+', 'image': '🔬', 'accredited': false, 'homeService': true, 'rating': 3.7},
    {'name': 'معمل السعادة الجديد', 'address': 'شارع التحرير، حي السعادة', 'lat': 15.3585, 'lng': 44.1905, 'phone': '01-001567', 'tests': '300+', 'image': '🧪', 'accredited': true, 'homeService': true, 'rating': 3.9},
    {'name': 'مختبر البشائر', 'address': 'شارع باب اليمن، حي البشائر', 'lat': 15.3435, 'lng': 44.1995, 'phone': '01-112678', 'tests': '460+', 'image': '🔬', 'accredited': true, 'homeService': false, 'rating': 4.4},
    {'name': 'معمل الكرامة', 'address': 'شارع القاهرة، حي الكرامة', 'lat': 15.3565, 'lng': 44.2075, 'phone': '01-223789', 'tests': '350+', 'image': '🧪', 'accredited': false, 'homeService': true, 'rating': 3.5},
    {'name': 'مختبر الصحة الجديد', 'address': 'شارع الستين، حي الصحة', 'lat': 15.3335, 'lng': 44.1815, 'phone': '01-334890', 'tests': '490+', 'image': '🔬', 'accredited': true, 'homeService': true, 'rating': 4.6},
    {'name': 'معمل التضامن', 'address': 'شارع العدين، حي التضامن', 'lat': 15.3895, 'lng': 44.2135, 'phone': '01-445901', 'tests': '270+', 'image': '🧪', 'accredited': false, 'homeService': false, 'rating': 3.3},
    {'name': 'مختبر الازدهار', 'address': 'شارع الزبيري، حي الازدهار', 'lat': 15.3505, 'lng': 44.2005, 'phone': '01-556012', 'tests': '440+', 'image': '🔬', 'accredited': true, 'homeService': true, 'rating': 4.3},
    {'name': 'معمل الأنوار الجديد', 'address': 'شارع هائل، حي الأنوار', 'lat': 15.3635, 'lng': 44.1965, 'phone': '01-667123', 'tests': '370+', 'image': '🧪', 'accredited': true, 'homeService': false, 'rating': 4.0},
  ];
  ...
  // ==================== 50+ أخرى (عيادات خاصة، مراكز تخصصية) ====================
  final List<Map<String, dynamic>> _others = [
    ...
    {'name': 'عيادة الدكتور صلاح', 'address': 'شارع الزبيري، شارع السائلة', 'lat': 15.3470, 'lng': 44.1950, 'phone': '01-777888', 'type': 'عيادة خاصة', 'specialties': 'باطنية', 'image': '⚕️', 'rating': 4.2},
    {'name': 'عيادة الدكتور طارق', 'address': 'شارع هائل، نهاية الخط', 'lat': 15.3660, 'lng': 44.1930, 'phone': '01-888999', 'type': 'عيادة خاصة', 'specialties': 'قلبية', 'image': '⚕️', 'rating': 4.6},
    {'name': 'عيادة الدكتور سامي', 'address': 'شارع الستين، تقاطع تعز', 'lat': 15.3170, 'lng': 44.1760, 'phone': '01-999000', 'type': 'عيادة خاصة', 'specialties': 'جلدية', 'image': '⚕️', 'rating': 3.8},
    {'name': 'عيادة الدكتور عادل', 'address': 'شارع القاهرة، بجانب المجلس', 'lat': 15.3570, 'lng': 44.2080, 'phone': '01-000111', 'type': 'عيادة خاصة', 'specialties': 'عيون', 'image': '⚕️', 'rating': 4.4},
    {'name': 'عيادة الدكتور نايف', 'address': 'شارع باب اليمن، بجانب الجامع', 'lat': 15.3450, 'lng': 44.1970, 'phone': '01-111222', 'type': 'عيادة خاصة', 'specialties': 'أنف وأذن وحنجرة', 'image': '⚕️', 'rating': 4.0},
    {'name': 'مركز علاج طبيعي النهضة', 'address': 'شارع العدين، طريق صنعاء', 'lat': 15.3840, 'lng': 44.2120, 'phone': '01-222333', 'type': 'مركز علاج طبيعي', 'specialties': 'علاج فيزيائي', 'image': '🦿', 'rating': 4.3},
    {'name': 'مركز علاج طبيعي العافية', 'address': 'شارع الزبيري، عمارة النجار', 'lat': 15.3460, 'lng': 44.1980, 'phone': '01-333444', 'type': 'مركز علاج طبيعي', 'specialties': 'علاج فيزيائي', 'image': '🦿', 'rating': 4.1},
    {'name': 'مركز صحي نفسي الأمل', 'address': 'شارع القاهرة، حي الحشيشي', 'lat': 15.3560, 'lng': 44.2070, 'phone': '01-444555', 'type': 'مركز صحي نفسي', 'specialties': 'صحة نفسية', 'image': '🧠', 'rating': 3.9},
    {'name': 'مركز صحي نفسي السكينة', 'address': 'شارع هائل، حي الروضة', 'lat': 15.3670, 'lng': 44.1920, 'phone': '01-555666', 'type': 'مركز صحي نفسي', 'specialties': 'صحة نفسية', 'image': '🧠', 'rating': 4.2},
    {'name': 'مركز الأمومة والطفولة', 'address': 'شارع الستين، مجمع النخبة', 'lat': 15.3330, 'lng': 44.1820, 'phone': '01-666777', 'type': 'مركز صحة أمومة', 'specialties': 'صحة أمومة وطفولة', 'image': '👩‍👧', 'rating': 4.5},
    {'name': 'مركز التغذية الصحية', 'address': 'شارع الخمسين، الحصبة', 'lat': 15.3780, 'lng': 44.2070, 'phone': '01-777888', 'type': 'مركز تغذية', 'specialties': 'تغذية علاجية', 'image': '🥗', 'rating': 4.3},
    {'name': 'مركز اللياقة البدنية', 'address': 'شارع التحرير، عمارة البساطي', 'lat': 15.3570, 'lng': 44.1940, 'phone': '01-888999', 'type': 'مركز لياقة', 'specialties': 'لياقة بدنية', 'image': '🏋️', 'rating': 4.4},
    {'name': 'مركز التأمل والاسترخاء', 'address': 'شارع باب اليمن، سوق الملح', 'lat': 15.3430, 'lng': 44.2000, 'phone': '01-999000', 'type': 'مركز تأمل', 'specialties': 'تأمل واسترخاء', 'image': '🧘', 'rating': 4.6},
    {'name': 'مركز الإقلاع عن التدخين', 'address': 'شارع الزبيري، شارع السائلة', 'lat': 15.3470, 'lng': 44.1950, 'phone': '01-000111', 'type': 'مركز إقلاع عن التدخين', 'specialties': 'صحة تنفسية', 'image': '🚭', 'rating': 4.1},
    {'name': 'دار رعاية الوفاء', 'address': 'شارع هائل، أمام المطار', 'lat': 15.3720, 'lng': 44.1890, 'phone': '01-111222', 'type': 'دار رعاية', 'specialties': 'رعاية كبار السن', 'image': '🧓', 'rating': 4.0},
    {'name': 'دار رعاية الأطفال', 'address': 'شارع القاهرة، بجانب المجلس', 'lat': 15.3570, 'lng': 44.2080, 'phone': '01-222333', 'type': 'دار رعاية', 'specialties': 'رعاية أطفال', 'image': '👶', 'rating': 4.3},
    {'name': 'عيادة الدكتور رضوان', 'address': 'شارع الستين، جولة آية', 'lat': 15.3400, 'lng': 44.1730, 'phone': '01-333444', 'type': 'عيادة خاصة', 'specialties': 'باطنية', 'image': '⚕️', 'rating': 4.2},
    {'name': 'عيادة الدكتور هشام', 'address': 'شارع الخمسين، خلف الجامعة', 'lat': 15.3790, 'lng': 44.2040, 'phone': '01-444555', 'type': 'عيادة خاصة', 'specialties': 'قلبية', 'image': '⚕️', 'rating': 4.7},
    {'name': 'عيادة الدكتور جمال', 'address': 'شارع العدين، السنينة الشمالية', 'lat': 15.3910, 'lng': 44.2150, 'phone': '01-555666', 'type': 'عيادة خاصة', 'specialties': 'جلدية', 'image': '⚕️', 'rating': 4.0},
    {'name': 'عيادة الدكتورة منى', 'address': 'شارع الزبيري، أمام الخطوط الجوية', 'lat': 15.3470, 'lng': 44.2000, 'phone': '01-666777', 'type': 'عيادة خاصة', 'specialties': 'نساء وولادة', 'image': '⚕️', 'rating': 4.8},
    {'name': 'عيادة الدكتور يحيى', 'address': 'شارع الستين، شارع العدين', 'lat': 15.3350, 'lng': 44.1860, 'phone': '01-777888', 'type': 'عيادة خاصة', 'specialties': 'عظام', 'image': '⚕️', 'rating': 4.4},
  ...
  List<Map<String, dynamic>> get _currentLocations {
    switch (widget.type) {
      ...
      case 'facilities': return _healthFacilities;
      case 'others': return _others;
      case 'tracking': return _hospitals;
      case 'all': return [..._hospitals, ..._pharmacies, ..._labs, ..._healthFacilities, ..._others];
  ...
  List<String> get _filterOptions {
    ...
    for (var loc in _currentLocations) {
      ...
      if (loc['specialties'] != null) types.add(loc['specialties'].toString());
    }
    return types.toList();
  }
      ...
      builder: (_) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            if (loc['services'] != null) _detailRow(Icons.medical_services, loc['services']),
            ...
            Row(
              children: [
                ...
                if (loc['emergency'] == true || loc['type'] == 'طوارئ' || loc['type'] == 'حكومي')
                  const SizedBox(width: 8),
                if (loc['emergency'] == true || loc['type'] == 'طوارئ' || loc['type'] == 'حكومي')
                  Expanded(
                    child: ElevatedButton.icon(
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // فلتر النوع
          if (widget.type != 'tracking' && _filterOptions.length > 1)
            Positioned(
              top: 70,
              left: 10,
              right: 10,
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Padding(
                      ...
                      child: FilterChip(
                        ...
                        onSelected: (selected) {
                          setState(() {
                            _filterType = selected ? option : 'الكل';
                          });
                        },
                ...
                onPressed: () {
                  showDialog(
                    ...
                    builder: (_) => AlertDialog(
                      title: const Text('اختر نوع المنشأة'),
                      content: Column(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          ListTile(
                          ...
                          ListTile(
                            ...
                            onTap: () {
                              ...
                              Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                  builder: (_) => const InteractiveMapScreen(type: 'facilities'),
                                ),
                              );
                            },
                          ),
                          ListTile(
                            ...
                            onTap: () {
                              ...
                              Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                  builder: (_) => const InteractiveMapScreen(type: 'others'),
                                ),
                              );
                            },
                          ),
                          ListTile(
                            ...
                            onTap: () {
                              ...
                              Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                  builder: (_) => const InteractiveMapScreen(type: 'all'),
                                ),
                              );
                            },
                          ),
          ...
          // عداد النتائج
          if (_searchQuery.isNotEmpty || _filterType != 'الكل')
            Positioned(
              top: widget.type == 'tracking' ? 130 : 120,
              left: 10,
              child: Container(
