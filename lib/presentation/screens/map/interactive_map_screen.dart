...
List<Map<String, dynamic>> get _currentLocations {
  ...
  final List<Map<String, dynamic>> _clinics = [
    {'name': 'عيادة الصحة بلس', 'address': 'شارع الستين، مقابل البنك المركزي', 'lat': 15.3550, 'lng': 44.2070, 'phone': '01-123456', 'hours': '8 ص - 10 م', 'image': '🏥', 'specialties': 'باطنية، أطفال، جلدية', 'homeService': true},
    {'name': 'عيادة الأمل', 'address': 'حي التحرير، شارع الضباب', 'lat': 15.3580, 'lng': 44.1980, 'phone': '01-234567', 'hours': '9 ص - 9 م', 'image': '🏥', 'specialties': 'عامة، أسنان، عيون', 'homeService': false},
    {'name': 'عيادة النور', 'address': 'شارع الزبيري، باب اليمن', 'lat': 15.3490, 'lng': 44.2000, 'phone': '01-345678', 'hours': '24 ساعة', 'image': '🏥', 'specialties': 'طوارئ، باطنية', 'homeService': true},
    {'name': 'عيادة الرحمة', 'address': 'شارع هائل، جولة كنتاكي', 'lat': 15.3630, 'lng': 44.1960, 'phone': '01-456789', 'hours': '8 ص - 11 م', 'image': '🏥', 'specialties': 'أطفال، نسائية', 'homeService': false},
    {'name': 'عيادة الشفاء', 'address': 'شارع التحرير، بجانب البريد', 'lat': 15.3610, 'lng': 44.1910, 'phone': '01-567890', 'hours': '9 ص - 10 م', 'image': '🏥', 'specialties': 'جلدية، تناسلية', 'homeService': true},
    {'name': 'عيادة الإيمان', 'address': 'شارع الخمسين، الحصبة', 'lat': 15.3780, 'lng': 44.2070, 'phone': '01-678901', 'hours': '8 ص - 8 م', 'image': '🏥', 'specialties': 'عامة، باطنية', 'homeService': false},
    {'name': 'عيادة الهدى', 'address': 'شارع القاهرة، حي السياسي', 'lat': 15.3530, 'lng': 44.2040, 'phone': '01-789012', 'hours': '24 ساعة', 'image': '🏥', 'specialties': 'طوارئ، أطفال', 'homeService': true},
    {'name': 'عيادة السلام', 'address': 'شارع باب اليمن، سوق الملح', 'lat': 15.3440, 'lng': 44.2010, 'phone': '01-890123', 'hours': '9 ص - 9 م', 'image': '🏥', 'specialties': 'أسنان، عظام', 'homeService': false},
    {'name': 'عيادة الفارابي', 'address': 'شارع العدين، السنينة', 'lat': 15.3860, 'lng': 44.2120, 'phone': '01-901234', 'hours': '8 ص - 10 م', 'image': '🏥', 'specialties': 'نفسية، أعصاب', 'homeService': true},
    {'name': 'عيادة الزهراء', 'address': 'شارع الستين، شارع تعز', 'lat': 15.3190, 'lng': 44.1790, 'phone': '01-012345', 'hours': '9 ص - 8 م', 'image': '🏥', 'specialties': 'نسائية، ولادة', 'homeService': false},
    {'name': 'عيادة ابن سينا', 'address': 'شارع هائل، حي الروضة', 'lat': 15.3670, 'lng': 44.1930, 'phone': '01-112233', 'hours': '24 ساعة', 'image': '🏥', 'specialties': 'باطنية، قلب', 'homeService': true},
    {'name': 'عيادة الحكمة', 'address': 'شارع التحرير، وسط البلد', 'lat': 15.3560, 'lng': 44.1950, 'phone': '01-223344', 'hours': '8 ص - 11 م', 'image': '🏥', 'specialties': 'عامة، أطفال', 'homeService': false},
    {'name': 'عيادة النجاح', 'address': 'شارع الزبيري، عمارة النجم', 'lat': 15.3500, 'lng': 44.1940, 'phone': '01-334455', 'hours': '9 ص - 9 م', 'image': '🏥', 'specialties': 'عيون، أنف وأذن', 'homeService': true},
    {'name': 'عيادة الأندلس', 'address': 'شارع الخمسين، مدينة النور', 'lat': 15.3760, 'lng': 44.2060, 'phone': '01-445566', 'hours': '8 ص - 10 م', 'image': '🏥', 'specialties': 'جلدية، تجميل', 'homeService': false},
    {'name': 'عيادة الفيحاء', 'address': 'شارع باب اليمن، شارع صالح', 'lat': 15.3420, 'lng': 44.1990, 'phone': '01-556677', 'hours': '24 ساعة', 'image': '🏥', 'specialties': 'طوارئ، باطنية', 'homeService': true},
    {'name': 'عيادة الربيع', 'address': 'شارع القاهرة، بجانب السفارة', 'lat': 15.3520, 'lng': 44.2050, 'phone': '01-667788', 'hours': '9 ص - 8 م', 'image': '🏥', 'specialties': 'أطفال، تغذية', 'homeService': false},
    {'name': 'عيادة اليمامة', 'address': 'شارع الستين، مجمع النخبة', 'lat': 15.3330, 'lng': 44.1830, 'phone': '01-778899', 'hours': '8 ص - 11 م', 'image': '🏥', 'specialties': 'عظام، علاج طبيعي', 'homeService': true},
    {'name': 'عيادة الصفوة', 'address': 'شارع هائل، أمام المطار', 'lat': 15.3720, 'lng': 44.1900, 'phone': '01-889900', 'hours': '9 ص - 9 م', 'image': '🏥', 'specialties': 'عامة، صدرية', 'homeService': false},
    {'name': 'عيادة البشير', 'address': 'شارع التحرير، عمارة الحمدي', 'lat': 15.3540, 'lng': 44.1920, 'phone': '01-990011', 'hours': '24 ساعة', 'image': '🏥', 'specialties': 'باطنية، أسنان', 'homeService': true},
    {'name': 'عيادة الإخلاص', 'address': 'شارع الزبيري، باب شعوب', 'lat': 15.3550, 'lng': 44.1960, 'phone': '01-001122', 'hours': '8 ص - 10 م', 'image': '🏥', 'specialties': 'نسائية، أطفال', 'homeService': false},
    {'name': 'عيادة الوفاء', 'address': 'شارع الخمسين، دار الرئاسة', 'lat': 15.3710, 'lng': 44.2040, 'phone': '01-112244', 'hours': '9 ص - 8 م', 'image': '🏥', 'specialties': 'قلب، ضغط', 'homeService': true},
    {'name': 'عيادة التعاون', 'address': 'شارع الستين، جولة المصباحي', 'lat': 15.3270, 'lng': 44.1820, 'phone': '01-223355', 'hours': '24 ساعة', 'image': '🏥', 'specialties': 'طوارئ، عامة', 'homeService': false},
    {'name': 'عيادة المستقبل', 'address': 'شارع باب اليمن، بجانب الجامع', 'lat': 15.3450, 'lng': 44.1970, 'phone': '01-334466', 'hours': '8 ص - 11 م', 'image': '🏥', 'specialties': 'عيون، أنف وأذن', 'homeService': true},
    {'name': 'عيادة الجزيرة', 'address': 'شارع القاهرة، حي الحشيشي', 'lat': 15.3560, 'lng': 44.2070, 'phone': '01-445577', 'hours': '9 ص - 9 م', 'image': '🏥', 'specialties': 'جلدية، تناسلية', 'homeService': false},
    {'name': 'عيادة الهلال', 'address': 'شارع العدين، طريق عمران', 'lat': 15.3880, 'lng': 44.2140, 'phone': '01-556688', 'hours': '24 ساعة', 'image': '🏥', 'specialties': 'باطنية، أطفال', 'homeService': true},
    {'name': 'عيادة طيبة', 'address': 'شارع الستين، شارع مأرب', 'lat': 15.3290, 'lng': 44.1800, 'phone': '01-667799', 'hours': '8 ص - 10 م', 'image': '🏥', 'specialties': 'عظام، علاج طبيعي', 'homeService': false},
    {'name': 'عيادة المنار', 'address': 'شارع هائل، نهاية الخط', 'lat': 15.3660, 'lng': 44.1940, 'phone': '01-778800', 'hours': '9 ص - 8 م', 'image': '🏥', 'specialties': 'عامة، صدرية', 'homeService': true},
    {'name': 'عيادة التقوى', 'address': 'شارع التحرير، أمام البنك', 'lat': 15.3590, 'lng': 44.1960, 'phone': '01-889911', 'hours': '24 ساعة', 'image': '🏥', 'specialties': 'طوارئ، قلب', 'homeService': false},
    {'name': 'عيادة الروضة', 'address': 'شارع الزبيري، عمارة النجار', 'lat': 15.3460, 'lng': 44.1980, 'phone': '01-990022', 'hours': '8 ص - 11 م', 'image': '🏥', 'specialties': 'أسنان، أطفال', 'homeService': true},
    {'name': 'عيادة الإحسان', 'address': 'شارع الخمسين، حي المطار', 'lat': 15.3750, 'lng': 44.2090, 'phone': '01-001133', 'hours': '9 ص - 9 م', 'image': '🏥', 'specialties': 'نسائية، ولادة', 'homeService': false},
    {'name': 'عيادة البراء', 'address': 'شارع باب اليمن، سوق الحلقة', 'lat': 15.3410, 'lng': 44.1980, 'phone': '01-112255', 'hours': '24 ساعة', 'image': '🏥', 'specialties': 'باطنية، جلدية', 'homeService': true},
    {'name': 'عيادة العنقاء', 'address': 'شارع القاهرة، بجانب المجلس', 'lat': 15.3570, 'lng': 44.2080, 'phone': '01-223366', 'hours': '8 ص - 10 م', 'image': '🏥', 'specialties': 'عامة، عظام', 'homeService': false},
    {'name': 'عيادة النهضة', 'address': 'شارع الستين، تقاطع تعز', 'lat': 15.3170, 'lng': 44.1770, 'phone': '01-334477', 'hours': '9 ص - 8 م', 'image': '🏥', 'specialties': 'أطفال، تغذية', 'homeService': true},
    {'name': 'عيادة اليسر', 'address': 'شارع هائل، فرع الجامعة', 'lat': 15.3690, 'lng': 44.1970, 'phone': '01-445588', 'hours': '24 ساعة', 'image': '🏥', 'specialties': 'طوارئ، عامة', 'homeService': false},
    {'name': 'عيادة السعادة', 'address': 'شارع التحرير، عمارة الكبوس', 'lat': 15.3600, 'lng': 44.1920, 'phone': '01-556699', 'hours': '8 ص - 11 م', 'image': '🏥', 'specialties': 'عيون، أنف وأذن', 'homeService': true},
    {'name': 'عيادة الخير', 'address': 'شارع الزبيري، شارع السائلة', 'lat': 15.3470, 'lng': 44.1950, 'phone': '01-667700', 'hours': '9 ص - 9 م', 'image': '🏥', 'specialties': 'جلدية، تجميل', 'homeService': false},
    {'name': 'عيادة الأنوار', 'address': 'شارع الخمسين، خلف الجامعة', 'lat': 15.3790, 'lng': 44.2050, 'phone': '01-778811', 'hours': '24 ساعة', 'image': '🏥', 'specialties': 'باطنية، قلب', 'homeService': true},
    {'name': 'عيادة الهداية', 'address': 'شارع الستين، شارع العدين', 'lat': 15.3350, 'lng': 44.1850, 'phone': '01-889922', 'hours': '8 ص - 10 م', 'image': '🏥', 'specialties': 'أسنان، أطفال', 'homeService': false},
    {'name': 'عيادة البستان', 'address': 'شارع باب اليمن، ميدان التحرير', 'lat': 15.3480, 'lng': 44.2010, 'phone': '01-990033', 'hours': '9 ص - 8 م', 'image': '🏥', 'specialties': 'نسائية، ولادة', 'homeService': true},
    {'name': 'عيادة الفردوس', 'address': 'شارع القاهرة، حي السياسي', 'lat': 15.3540, 'lng': 44.2040, 'phone': '01-001144', 'hours': '24 ساعة', 'image': '🏥', 'specialties': 'طوارئ، باطنية', 'homeService': false},
    {'name': 'عيادة التوفيق', 'address': 'شارع هائل، جولة كنتاكي', 'lat': 15.3640, 'lng': 44.1960, 'phone': '01-112266', 'hours': '8 ص - 11 م', 'image': '🏥', 'specialties': 'عامة، صدرية', 'homeService': true},
    {'name': 'عيادة الريان', 'address': 'شارع التحرير، بجانب البريد', 'lat': 15.3610, 'lng': 44.1910, 'phone': '01-223377', 'hours': '9 ص - 9 م', 'image': '🏥', 'specialties': 'عظام، علاج طبيعي', 'homeService': false},
    {'name': 'عيادة دار الشفاء', 'address': 'شارع الزبيري، أمام الخطوط الجوية', 'lat': 15.3470, 'lng': 44.2000, 'phone': '01-334488', 'hours': '24 ساعة', 'image': '🏥', 'specialties': 'باطنية، أطفال', 'homeService': true},
    {'name': 'عيادة الأمن', 'address': 'شارع الخمسين، شارع الستين', 'lat': 15.3380, 'lng': 44.1880, 'phone': '01-445599', 'hours': '8 ص - 10 م', 'image': '🏥', 'specialties': 'جلدية، تناسلية', 'homeService': false},
    {'name': 'عيادة الصادق', 'address': 'شارع الستين، جولة 48', 'lat': 15.3360, 'lng': 44.1870, 'phone': '01-556600', 'hours': '9 ص - 8 م', 'image': '🏥', 'specialties': 'عيون، أنف وأذن', 'homeService': true},
    {'name': 'عيادة الفتح', 'address': 'شارع باب اليمن، شارع باب اليمن', 'lat': 15.3500, 'lng': 44.1990, 'phone': '01-667711', 'hours': '24 ساعة', 'image': '🏥', 'specialties': 'طوارئ، عامة', 'homeService': false},
    {'name': 'عيادة النصر', 'address': 'شارع القاهرة، بجانب سوق القات', 'lat': 15.3510, 'lng': 44.2030, 'phone': '01-778822', 'hours': '8 ص - 11 م', 'image': '🏥', 'specialties': 'أسنان، أطفال', 'homeService': true},
    {'name': 'عيادة العروبة', 'address': 'شارع هائل، شارع الأربعين', 'lat': 15.3630, 'lng': 44.1980, 'phone': '01-889933', 'hours': '9 ص - 9 م', 'image': '🏥', 'specialties': 'نسائية، ولادة', 'homeService': false},
    {'name': 'عيادة القاسمي', 'address': 'شارع التحرير، عمارة البساطي', 'lat': 15.3580, 'lng': 44.1940, 'phone': '01-990044', 'hours': '24 ساعة', 'image': '🏥', 'specialties': 'باطنية، قلب', 'homeService': true},
    {'name': 'عيادة الزيتون', 'address': 'شارع الخمسين، الحصبة', 'lat': 15.3780, 'lng': 44.2070, 'phone': '01-001155', 'hours': '8 ص - 10 م', 'image': '🏥', 'specialties': 'عامة، صدرية', 'homeService': false},
    {'name': 'عيادة الأقصى', 'address': 'شارع الستين، شارع الستين الشمالي', 'lat': 15.3390, 'lng': 44.1720, 'phone': '01-112277', 'hours': '9 ص - 8 م', 'image': '🏥', 'specialties': 'عظام، علاج طبيعي', 'homeService': true},
    {'name': 'عيادة الروح', 'address': 'شارع باب اليمن، شارع صالح', 'lat': 15.3430, 'lng': 44.2000, 'phone': '01-223388', 'hours': '24 ساعة', 'image': '🏥', 'specialties': 'نفسية، أعصاب', 'homeService': false},
    {'name': 'عيادة الضياء', 'address': 'شارع القاهرة، حي الحشيشي', 'lat': 15.3560, 'lng': 44.2070, 'phone': '01-334499', 'hours': '8 ص - 11 م', 'image': '🏥', 'specialties': 'عيون، أنف وأذن', 'homeService': true},
    {'name': 'عيادة الرازي', 'address': 'شارع هائل، أمام المطار', 'lat': 15.3720, 'lng': 44.1890, 'phone': '01-445500', 'hours': '9 ص - 9 м', 'image': '🏥', 'specialties': 'جلدية، تجميل', 'homeService': false},
    {'name': 'عيادة الفاروق', 'address': 'شارع التحرير، وسط البلد', 'lat': 15.3560, 'lng': 44.1950, 'phone': '01-556611', 'hours': '24 ساعة', 'image': '🏥', 'specialties': 'طوارئ، باطنية', 'homeService': true},
    {'name': 'عيادة الهدى الجديدة', 'address': 'شارع الخمسين، مدينة النور', 'lat': 15.3760, 'lng': 44.2050, 'phone': '01-667722', 'hours': '8 ص - 10 م', 'image': '🏥', 'specialties': 'أطفال، تغذية', 'homeService': false},
    {'name': 'عيادة البركة', 'address': 'شارع الستين، مجمع الصمد', 'lat': 15.3310, 'lng': 44.1840, 'phone': '01-778833', 'hours': '9 ص - 8 م', 'image': '🏥', 'specialties': 'عامة، أسنان', 'homeService': true},
    {'name': 'عيادة النور الجديدة', 'address': 'شارع الزبيري، باب شعوب', 'lat': 15.3550, 'lng': 44.1960, 'phone': '01-889944', 'hours': '24 ساعة', 'image': '🏥', 'specialties': 'باطنية، قلب', 'homeService': false},
    {'name': 'عيادة الأمل الجديدة', 'address': 'شارع باب اليمن، سوق الملح', 'lat': 15.3440, 'lng': 44.2010, 'phone': '01-990055', 'hours': '8 ص - 11 م', 'image': '🏥', 'specialties': 'نسائية، ولادة', 'homeService': true},
    {'name': 'عيادة السلام الجديدة', 'address': 'شارع القاهرة، حي السياسي', 'lat': 15.3530, 'lng': 44.2040, 'phone': '01-001166', 'hours': '9 ص - 9 م', 'image': '🏥', 'specialties': 'عظام، علاج طبيعي', 'homeService': false},
  ];
