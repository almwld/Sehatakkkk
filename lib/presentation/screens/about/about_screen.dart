        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Padding(
                padding: const EdgeInsets.all(20),
                child: Image.asset('assets/icons/app_icon.png', width: 60, height: 60, fit: BoxFit.contain),
              ),
            ),
            const SizedBox(height: 20),
            const Text('صحتك', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold)),
            const SizedBox(height: 4),
            Text('Sehatak', style: TextStyle(fontSize: 16, color: AppColors.grey, letterSpacing: 2)),
            const SizedBox(height: 8),
            Container(
              padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 6),
              decoration: BoxDecoration(color: AppColors.primary.withOpacity(0.1), borderRadius: BorderRadius.circular(12)),
              child: Text('الإصدار $_appVersion+$_buildNumber', style: TextStyle(fontSize: 13, color: AppColors.primary, fontWeight: FontWeight.w600)),
            ),
            ...
            Container(
              ...
              child: Column(
                children: [
                  const Text('منصة الرعاية الصحية الشاملة في اليمن', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold), textAlign: TextAlign.center),
                  const SizedBox(height: 12),
                  Text('تطبيق "صحتك" هو منصة طبية متكاملة تهدف إلى تسهيل الوصول إلى الخدمات الصحية في اليمن. نوفر لك إمكانية حجز المواعيد، والاستشارات الطبية، وطلب الأدوية، ومتابعة حالتك الصحية بكل سهولة وأمان.', style: TextStyle(fontSize: 14, color: AppColors.grey, height: 1.6), textAlign: TextAlign.center),
                ],
              ),
            ),
            ...
            const SizedBox(height: 30),
            Text('© 2026 Sehatak Platform', style: TextStyle(fontSize: 12, color: AppColors.grey)),
            const SizedBox(height: 4),
            Text('جميع الحقوق محفوظة', style: TextStyle(fontSize: 11, color: AppColors.grey.withOpacity(0.7))),
            const SizedBox(height: 30),
          ],
        ),
      ),
  ...
  Widget _buildFeatureSection(bool isDark) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text('الميزات الرئيسية', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
          const SizedBox(height: 12),
          GridView.builder(
            shrinkWrap: true,
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                child: Column(
                  ...
                  children: [
                    LocalAssetIcon(feature['icon'] as String, color: AppColors.primary, size: 28),
                    const SizedBox(height: 4),
                    Text(feature['title'] as String, style: const TextStyle(fontSize: 11, fontWeight: FontWeight.w600)),
                    Text(feature['desc'] as String, style: TextStyle(fontSize: 9, color: AppColors.grey), textAlign: TextAlign.center),
                  ],
                ),
              );
            },
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            spacing: 12,
            runSpacing: 12,
            children: socials.map((social) => GestureDetector(
              ...
              child: Column(
                children: [
                  Container(
                    ...
                    height: 50,
                    decoration: BoxDecoration(color: AppColors.primary.withOpacity(0.1), borderRadius: BorderRadius.circular(12)),
                    child: Center(child: LocalAssetIcon(social['icon'] as String, size: social['label'] == 'لينكد إن' ? 24 : 28)),
                  ),
                  const SizedBox(height: 6),
                  Text(social['label'] as String, style: TextStyle(fontSize: 11, color: AppColors.grey)),
                ],
              ),
            )).toList(),
          ),
