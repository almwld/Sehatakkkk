...
class MedicalKnowledgeBase {
  ...
  final Map<String, Map<String, dynamic>> drugsDb = {
    ...
    'ايبوبروفين': {
      'name_en': 'Ibuprofen',
      'category': 'مضاد التهاب غير.يتيرويدي',
      ...
      'interactions': 'مميعات دم، ليثيوم، ميثوتر.ييت',
    ...
    'ميتفورمين': {
      ...
      'interactions': 'كحول، سيميتيدين، فور.ييميد',
    ...
    'حديد': {
      ...
      'interactions': 'مضادات حموضة، تتر.يايكلين',
    ...
    'فوليك أسيد': {
      ...
      'breastfeeding': 'آمن',
      'side_effects': 'نادر',
      'interactions': 'مضادات اختلاج، ميثوتر.ييت',
  ...
  final Map<String, Map<String, dynamic>> diseasesDb = {
    ...
    'التهاب المفاصل': {
      ...
      'emergency_warning': 'ألم مفاصل شديد، حمى، تورم أحمر.ياخن',
    },
    'الصداع النصفي': {
      'category': 'أعصاب',
    ...
    'التهاب الكبد': {
      ...
      'causes': 'فير.يات، كحول، أدوية سامة، مناعة ذاتية',
      'treatment': 'راحة، مضادات فير.يية، تطعيم',
...
class TriageEngine {
  ...
  List<Map<String, dynamic>> getPossibleConditions(String symptoms, {String? bodyPart}) {
    ...
    final conditionsMap = {
      ...
      'طب الأطفال': [
        {'name': 'التهاب حلق فير.يي', 'probability': 'مرتفع', 'treatment': 'سوائل دافئة، راحة، بار.ييتامول'},
