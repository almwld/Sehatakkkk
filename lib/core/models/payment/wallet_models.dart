...
import 'package:flutter/material.dart'; // ✅ إضافة هذا السطر
...
class LocalWalletOption {
  ...
  static const List<LocalWalletOption> wallets = [
    ...
    LocalWalletOption(
      ...
      name: 'فلوسك',
      assetPath: 'assets/images/payment/floosak.webp',
      accountNumber: '536396',
      description: 'التحويل إلى حساب الدفع الموحد عبر جيب',
    ),
    LocalWalletOption(
      ...
      name: 'جوالي',
      assetPath: 'assets/images/payment/jawali.webp',
      accountNumber: '536396',
      description: 'التحويل إلى حساب الدفع الموحد عبر جيب',
    ),
    LocalWalletOption(
      ...
      name: 'جيب',
      assetPath: 'assets/images/payment/jeeb.webp',
      accountNumber: '536396',
      description: 'حساب الدفع الموحد',
    ),
    LocalWalletOption(
      type: PaymentMethodType.kash,
      name: 'كاش',
      assetPath: 'assets/images/payment/kash.webp',
      accountNumber: '536396',
      description: 'التحويل إلى حساب الدفع الموحد عبر جيب',
    ),
    LocalWalletOption(
      ...
      name: 'كاش ون',
      assetPath: 'assets/images/payment/kash_one.webp',
      accountNumber: '536396',
      description: 'التحويل إلى حساب الدفع الموحد عبر جيب',
    ),
    LocalWalletOption(
      ...
      name: 'موبايل ماني',
      assetPath: 'assets/images/payment/mobile_money.webp',
      accountNumber: '536396',
      description: 'التحويل إلى حساب الدفع الموحد عبر جيب',
    ),
    LocalWalletOption(
      ...
      name: 'يمن وولت',
      assetPath: 'assets/images/payment/yemen_wallet.webp',
      accountNumber: '536396',
      description: 'التحويل إلى حساب الدفع الموحد عبر جيب',
    ),
    LocalWalletOption(
      ...
      name: 'إيزي',
      assetPath: 'assets/images/payment/easy.webp',
      accountNumber: '536396',
      description: 'التحويل إلى حساب الدفع الموحد عبر جيب',
    ),
  ];
