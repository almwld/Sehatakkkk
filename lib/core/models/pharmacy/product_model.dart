...
class ProductModel {
  ...
  ProductModel({required this.id, required this.name, required this.nameEn, required this.category, required this.description, required this.price, this.discount, this.imageUrl, this.manufacturer, this.barcode, required this.stockQuantity, this.dosage, this.usage, this.sideEffects, this.interactions, this.prescriptionRequired = false, this.inStock = true, this.rating = 0.0, this.reviewsCount = 0, this.keywords = const [], required this.createdAt, this.expiryDate, this.storageInstructions, this.genericName, this.dosageForm, this.alternativeProducts, this.metadata});
  ...
  String get resolvedImageUrl => ImageKit.productImage(imageUrl: imageUrl, dosageForm: dosageForm, category: categoryText, genericName: genericName);
