...
class ChatWallpapers {
  static const List<Wallpaper> wallpapers = [
    Wallpaper(id: 'default_light', name: 'افتراضي فاتح', assetPath: 'assets/images/sehatak_chat_wallpaper_light_1080x2160.webp', isDark: false, type: 'image'),
    Wallpaper(id: 'default_dark', name: 'افتراضي داكن', assetPath: 'assets/images/sehatak_chat_wallpaper_dark_1080x2160.webp', isDark: true, type: 'image'),
