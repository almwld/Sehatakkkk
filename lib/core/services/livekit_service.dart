...
class LiveKitService {
  ...
  Future<void> endCall() async { try { await _room?.disconnect(); } finally { _room = null; _isConnected = false; _isCameraEnabled = false; _isMicrophoneEnabled = false; _isSpeakerOn = false; _isFrontCamera = true; } }
