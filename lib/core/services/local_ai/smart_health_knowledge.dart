...
class SmartHealthKnowledge {
  static const List<Map<String, dynamic>> services = [
    {'title': 'الأطباء', 'keywords': ['طبيب', 'دكتور', 'دكتورة', 'تخصص'], 'route': '/doctors', 'icon': Icons.medical_services_outlined, 'help': 'البحث عن طبيب واختيار التخصص المناسب.'},
    {'title': 'الصيدلية', 'keywords': ['دواء', 'صيدلية', 'دواءاتي', 'دواء'], 'route': '/pharmacy', 'icon': Icons.local_pharmacy_outlined, 'help': 'البحث عن الأدوية والمنتجات الصحية.'},
    {'title': 'المختبرات', 'keywords': ['مختبر', 'تحليل', 'تحاليل', 'فحص', 'نتيجة'], 'route': '/labs', 'icon': Icons.biotech_outlined, 'help': 'الوصول إلى خدمات المختبرات ونتائج الفحوصات.'},
    ...
    {'title': 'الاستشارة الطبية', 'keywords': ['استشارة', 'استشاره', 'طبيب عن بعد', 'استشارة طبية'], 'route': '/consultation', 'icon': Icons.video_call_outlined, 'help': 'بدء أو متابعة استشارة طبية.'},
    {'title': 'الطوارئ', 'keywords': ['طوارئ', 'اسعاف', 'إسعاف', 'طارئ', 'نجدة'], 'route': '/emergency', 'icon': Icons.emergency_outlined, 'help': 'الوصول السريع لخدمات الطوارئ والأرقام المهمة.'},
    {'title': 'الخدمات', 'keywords': ['خدمات', 'جميع الخدمات', 'الخدمات الصحية'], 'route': '/services', 'icon': Icons.grid_view_outlined, 'help': 'استعراض جميع خدمات صحتك.'},
    ...
    {'title': 'الخريطة', 'keywords': ['خريطة', 'موقع', 'مستشفى قريب', 'صيدلية قريبة', 'مختبر قريب'], 'route': '/map', 'icon': Icons.map_outlined, 'help': 'العثور على المنشآت والخدمات الصحية على الخريطة.'},
  ];
