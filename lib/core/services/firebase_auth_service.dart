...
class FirebaseAuthService {
  ...
  Future<User?> loginWithPhone(String phone, String password) async {
    try {
      final result = await _auth.signInWithEmailAndPassword(email: '$phone@sehatak.com', password: password.trim());
      return result.user;
    } on FirebaseAuthException catch (e) {
      throw _handleAuthError(e);
    }
  ...
  Future<User?> registerDoctor(String name, String email, String password, String phone, String specialty, String license) async {
    try {
      final result = await _auth.createUserWithEmailAndPassword(email: email.trim(), password: password.trim());
