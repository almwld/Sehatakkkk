...
class AppRouter {
  ...
  static Route<dynamic>? onGenerateRoute(RouteSettings routeSettings) {
    ...
    switch (name) {
      ...
      case chatRoom: return MaterialPageRoute(builder: (_) => const ChatRoomScreen(chatId: '', otherUserId: '', otherUserName: 'مستخدم', isGroup: false), settings: routeSettings);
      case addStatus: return MaterialPageRoute(builder: (_) => const AddStatusScreen(), settings: routeSettings);
      ...
      case wallet: return MaterialPageRoute(builder: (_) => const WalletScreen(), settings: routeSettings);
