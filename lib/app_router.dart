...
class AppRouter {
  ...
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(path: dashboard, builder: (context, state) => const PatientDashboard()),
      GoRoute(path: profile, builder: (context, state) => const PatientProfile()),
      GoRoute(path: notifications, builder: (context, state) => const NotificationsScreen()),
      GoRoute(path: cart, builder: (context, state) => const CartScreen()),
      GoRoute(path: wallet, builder: (context, state) => const WalletScreen()),
      GoRoute(path: map, builder: (context, state) => const InteractiveMapScreen()),
      ...
      GoRoute(path: emergency, builder: (context, state) => const EmergencyNumbers()),
